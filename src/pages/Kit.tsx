...
export default function Kit() {
  ...
  const handleCheckout = () => {
    if (!email) return;
    window.open("https://buy.stripe.com/dRmcN59u7dpQeefgDda7C0a", "_blank");
  };

  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-pink-950">
      <header className="border-b border-pink-900/30 bg-black/20 backdrop-blur-sm">
      ...
      <main className="mx-auto max-w-5xl px-6 py-16">
        <div className="grid gap-12 lg:grid-cols-2 items-start">
          ...
          <Card className="bg-slate-900/80 border-pink-500/20 backdrop-blur-sm sticky top-8">
            <CardHeader>
            ...
            <CardContent className="space-y-3">
              ...
              <div className="pt-4 border-t border-slate-700">
                <div className="flex items-baseline gap-2 mb-2">
                  ...
                  <span className="text-slate-400 line-through text-lg">$47</span>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg bg-slate-800 border border-slate-600 text-white placeholder:text-slate-500 mb-3 focus:outline-none focus:border-pink-500"
                />
                <Button
                  onClick={handleCheckout}
                  className="w-full bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white font-semibold py-6 text-lg"
                >
